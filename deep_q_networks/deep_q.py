...
class Qnetwork():
    def __init__(self,h_size):
        # Recieves a frame, flattens to an array, resizes and processes through 4 conv layers
        ...
        # Take the output from the final conv layer and split it to separate advantage and value streams
        ...
        # Combine them to get our final Q-values
...
with tf.Session() as sess:
    ...
    for i in range(num_episodes):
        ...
        while j < max_epLength:
            j += 1
            # Choose an action greedily w/randomness
            ...
            s1 = processState(s1)
            total_steps += 1
            episodeBuffer.add(np.reshape(np.array([s,a,r,s1,d]),[1,5])) # Save the experience
