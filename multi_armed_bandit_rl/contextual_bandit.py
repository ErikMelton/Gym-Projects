...
class agent():
    def __init__(self, lr, s_size, a_size):
        ...
        output = slim.fully_connected(state_in_OH,a_size,weights_initializer=tf.ones_initializer())
...
tf.reset_default_graph() # Clear TF graph
...
e = 0.1 # Set chance of taking a random action
